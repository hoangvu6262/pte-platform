  ...
  return (
    <div>
      <div className="practise-body reading">
        <PageHeader
          logo="https://dl26yht2ovo33.cloudfront.net/public/admin/practice_assets/q_images/smw_l_v2.png"
          title="Select Missing Word"
          chip="Study Guide"
          linkGuide={`/intro/${key}`}
          idExercise={testExamDetail.name}
          content="You will hear a recording about fiction writing. At the end of the recording the lost word or group of words has been replaced by a beep. Select the correct option to complete the recording."
        />
        ...
        <div className="practise-body__paragraph reading-paragraph">
          <Paragraph content="At the end of the recording the lost word or group of words has been replaced by a beep. Select the correct option to complete the recording." />
        </div>
